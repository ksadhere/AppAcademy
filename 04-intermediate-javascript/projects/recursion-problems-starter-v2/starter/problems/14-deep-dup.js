...
1. check the base case: If arr is empty, then return the new array
2. Otherwise, push the create a shallow copy of the array
...
/**
 * It takes an array, and returns a new array with the same elements, but with any sub-arrays
 * deep-duplicated
